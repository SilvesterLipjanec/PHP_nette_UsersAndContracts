<?php
// source: /var/www/html/sandbox/app/config/config.neon 
// source: /var/www/html/sandbox/app/config/config.local.neon 

class Container_79c2dd2e84 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/html/sandbox/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/var/www/html/sandbox/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/sandbox/app/../temp/cache',
	...
	{
		return new Container_79c2dd2e84_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_79c2dd2e84_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_79c2dd2e84 $container)
	{
