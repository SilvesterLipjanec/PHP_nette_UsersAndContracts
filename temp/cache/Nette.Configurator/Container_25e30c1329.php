<?php
// source: /var/www/html/synopsis/app/config/config.neon 
// source: /var/www/html/synopsis/app/config/config.local.neon 

class Container_25e30c1329 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Security\IAuthenticator' => [1 => ['25_App_Model_Authenticator']],
			'App\Model\Authenticator' => [1 => ['25_App_Model_Authenticator']],
			'App\Model\DatabaseRepository' => [1 => ['26_App_Model_DatabaseRepository']],
			...
			'App\Presenters\ContractsPresenter' => [1 => ['application.1']],
		...
		'services' => [
			...
			'25_App_Model_Authenticator' => 'App\Model\Authenticator',
			'26_App_Model_DatabaseRepository' => 'App\Model\DatabaseRepository',
			'application.1' => 'App\Presenters\ContractsPresenter',
	...
	{
		parent::__construct([
			'appDir' => '/var/www/html/synopsis/app',
			'wwwDir' => '/var/www/html/synopsis/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => '/var/www/html/synopsis/app/../temp',
		]);
	}
	 ...
	 */
	public function createService__25_App_Model_Authenticator()
	{
		$service = new App\Model\Authenticator($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\DatabaseRepository
	 */
	public function createService__26_App_Model_DatabaseRepository()
	{
		$service = new App\Model\DatabaseRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Presenters\ContractsPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\ContractsPresenter($this->getService('26_App_Model_DatabaseRepository'));
	...
	{
		$service = new App\Presenters\BasePresenter($this->getService('26_App_Model_DatabaseRepository'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\Error4xxPresenter($this->getService('26_App_Model_DatabaseRepository'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('26_App_Model_DatabaseRepository'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/html/synopsis/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/var/www/html/synopsis/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/synopsis/app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=quickstart', 'silvester',
			'aaa', NULL);
	...
	{
		return new Container_25e30c1329_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('25_App_Model_Authenticator'));
...
final class Container_25e30c1329_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_25e30c1329 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('/var/www/html/synopsis/app/../temp/cache/latte');
