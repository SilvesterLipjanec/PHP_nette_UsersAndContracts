...
class Container_b2e6c26441 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\BasePresenter' => [1 => ['application.1', 'application.2', 'application.3']],
			'Nette\Application\UI\Presenter' => [['application.1', 'application.2', 'application.3']],
			'Nette\Application\UI\Control' => [['application.1', 'application.2', 'application.3']],
			'Nette\Application\UI\Component' => [['application.1', 'application.2', 'application.3']],
			'Nette\ComponentModel\Container' => [['application.1', 'application.2', 'application.3']],
			'Nette\ComponentModel\Component' => [['application.1', 'application.2', 'application.3']],
			'Nette\Application\UI\IRenderable' => [['application.1', 'application.2', 'application.3']],
			'Nette\ComponentModel\IContainer' => [['application.1', 'application.2', 'application.3']],
			'Nette\ComponentModel\IComponent' => [['application.1', 'application.2', 'application.3']],
			'Nette\Application\UI\ISignalReceiver' => [['application.1', 'application.2', 'application.3']],
			'Nette\Application\UI\IStatePersistent' => [['application.1', 'application.2', 'application.3']],
			'ArrayAccess' => [['application.1', 'application.2', 'application.3']],
	...
	{
		return new Container_b2e6c26441_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_b2e6c26441_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_b2e6c26441 $container)
	{
